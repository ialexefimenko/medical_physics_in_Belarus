...
\renewcommand{\baselinestretch}{1} % Полуторный межстрочный интервал
...
\renewcommand{\labelitemi}{$\bullet$} % Маркет списка $\circ$ $\bullet$ {--}
...
\renewcommand{\headrulewidth}{0pt} % Декоративные линии
